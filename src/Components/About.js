  ...
  return (
    <div className="a">
      ...
      <div className="a-right">
        ...
        <p className="a-sub">
          I believe in Innovation as an Outcome of habbit not a random act
        ...
        <div className="a-award">
          ...
          <div className="a-award-texts">
            <h4 className="a-award-title">Best Personality Awards 2021</h4>
            <p className="a-award-desc">
              People we offer services to are the ones we gain recorgnitions from.<br></br> My Passion has always being Humanity first above all things
            </p>
          </div>
        </div>
      </div>
